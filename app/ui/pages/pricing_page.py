...
FIELD_DEFS = [
    ...
    ("sensor_bewegungsmelder", "Sensor: Bewegungsmelder"),
    ("sensor_praesenzmelder", "Sensor: Präsenzmelder (mmWave)"),
    ("sensor_fensterkontakt", "Sensor: Fensterkontakt"),
    ("sensor_tuerkontakt", "Sensor: Türkontakt"),
    ("sensor_temperatur", "Sensor: Temperatur"),
    ("sensor_luftfeuchte", "Sensor: Luftfeuchte"),
    ("sensor_co2_luftqualitaet", "Sensor: CO₂ / Luftqualität"),
    ("sensor_helligkeit", "Sensor: Helligkeit"),
    ("sensor_outdoor_temperatur", "Outdoor-Sensor: Temperatur"),
    ("sensor_outdoor_luftfeuchte", "Outdoor-Sensor: Luftfeuchte"),
    ("sensor_outdoor_helligkeit", "Outdoor-Sensor: Helligkeit"),
    ("sensor_outdoor_bewegungsmelder", "Outdoor-Sensor: Bewegungsmelder"),
    ("sensor_outdoor_wetterstation", "Outdoor-Sensor: Wetterstation"),
    ("sensor_outdoor_smarter_gartenaktor", "Outdoor: Smarter Gartenaktor"),
